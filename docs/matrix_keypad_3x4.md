...
![شكل لوحة المفاتيح المصفوفية 3×4](img/parts/65a0b7d4d7ab4b1dcfcb522044a372c8a9bc3111.jpeg)
**الشكل 1:** شكل لوحة المفاتيح المصفوفية 3×4 (نموذج من أحد المصنّعين).

![مخطط أرجل لوحات المفاتيح 3×4 و 4×4](img/parts/Arduino-Keypad-Tutorial-4X4-and-3X4-Keypad-Pin-Diagram.png)
...
![توصيل لوحة المفاتيح مع مقاومات السحب للأسفل](img/connections/keypad_connection_with_pull_down_resistors.png)
...
![توصيل لوحة المفاتيح مباشرة بدون مقاومات](img/connections/key_pad_connection_directly.png)
